...
export const concepts = [
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["HTTP basics", "Cookie / session 概念"],
    tag: "API 設計",
...
query {
  ...
  },
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["HTTP basics", "Cache 概念"],
    tag: "效能",
    title: "CDN 是什麼",
...
def rag(question):
  ...
  },
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["Network layers"],
    tag: "網路",
    title: "TCP vs UDP",
...
UDP 像「明信片」——丟出去就算，不確認、不重傳、不保證順序。代價是有些封包會丟，但對某些場景反而是優點：直播、視訊通話、遊戲——晚到的封包已經沒用了（你想看 10 秒前的畫面嗎？），寧可丟掉繼續往前。可靠性和延遲在這裡是矛盾的，TCP 選可靠，UDP 選即時。`,
  ...
  },
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["Memory model", "OS process"],
    tag: "工程",
    title: "Docker 的核心價值",
...
CMD ["node", "server.js"]`,
  ...
  },
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["SQL", "Data structures（樹 / 雜湊）"],
    tag: "資料庫",
    title: "資料庫 Index",
...
-- EXPLAIN: type=ref, rows=1`,
  ...
  },
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["HTTP basics", "Token / web auth"],
    tag: "安全",
    title: "OAuth 2.0",
...
app.post("/webhook/stripe", (req, res) => {
  ...
  },
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["Embedding", "相似度搜尋"],
    tag: "AI",
    title: "向量資料庫",
...
b(); // 1  ← b 有自己的 n，不共享`,
  ...
  },
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["Memory model", "Reference vs value"],
    tag: "程式設計",
...
// 10 萬筆：慢的 ~100 億次操作，快的 ~10 萬次`,
  ...
  },
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["OOP basics", "Class / instance"],
    tag: "程式設計",
...
spy.mockRestore();`,
  ...
  },
  {
    ...
    level: 2,
    prerequisites: [],
    assumedKnowledge: ["Memory model", "Pointer / 指標"],
    tag: "工程",
...
function addWidget(el) {
  ...
  },
  {
    ...
    level: 3,
    prerequisites: [],
    assumedKnowledge: ["HTTP basics", "重試 / 失敗處理場景"],
    tag: "API 設計",
    title: "Idempotency",
